...
jobfile = {'/Users/emilyhahn/projects/6month_vs_baseline_oneway_ANOVA_within_subjects_job.m'};
...
for crun = 1:nrun
    ...
    inputs{12, crun} = MATLAB_CODE_TO_FILL_INPUT; % Factorial design specification: Scans - cfg_files
end
spm('defaults', 'PET');
