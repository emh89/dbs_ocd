...
jobfile = {'/Users/emilyhahn/projects/6month_vs_baseline_oneway_ANOVA_within_subjects_ybocs_job.m'};
...
for crun = 1:nrun
    ...
    inputs{9, crun} = MATLAB_CODE_TO_FILL_INPUT; % Factorial design specification: Scans - cfg_files
    inputs{10, crun} = MATLAB_CODE_TO_FILL_INPUT; % Factorial design specification: Scans - cfg_files
    inputs{11, crun} = MATLAB_CODE_TO_FILL_INPUT; % Factorial design specification: Scans - cfg_files
    inputs{12, crun} = MATLAB_CODE_TO_FILL_INPUT; % Factorial design specification: Vector - cfg_entry
end
spm('defaults', 'PET');
